...
const THEMES: Record<Theme, { from: string; to: string; ring: string; chip: string; text: string }> = {
  blue:   { from: "#FB923C", to: "#F97316", ring: "rgba(249,115,22,0.25)",  chip: "rgba(249,115,22,0.08)",  text: "#9A3412" },
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-[6px] rounded-full mb-5"
            ...
            <span className="inline-block w-[6px] h-[6px] rounded-full" style={{ background: "#F97316", boxShadow: "0 0 6px #F97316" }} />
          ...
          {WORKFLOWS.map((w, i) => {
            ...
            return (
              <motion.div
                ...
                onMouseLeave={(e) => { e.currentTarget.style.boxShadow = "0 4px 14px rgba(154,52,18,0.06)"; }}
              >
