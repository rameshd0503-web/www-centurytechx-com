  ...
  return (
    <>
      ...
      <header
        ...
        style={{
          height: 70,
          background: scrolled ? "var(--bg-glass)" : "rgba(255,255,255,0.86)",
      ...
      >
        <div className="h-full max-w-[1440px] mx-auto px-5 md:px-8 flex items-center justify-between">
          ...
          >
            <span
              ...
              style={{
                ...
                boxShadow:
                  "0 0 14px rgba(249,115,22,0.35), inset 0 0 0 1px rgba(0,0,0,0.05)",
              }}
            >
              <img
                src={logoUrl}
          ...
          <a
            href="#contact"
            className="fx-shine fx-breathe fx-press hidden md:inline-flex items-center font-orbitron font-bold text-[11px] tracking-[0.15em] text-white px-5 py-[10px] rounded-[8px] transition-all duration-200"
